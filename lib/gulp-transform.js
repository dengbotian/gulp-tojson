...
var Converter=require('tojson').core.Converter;
...
Transform.prototype.json = function(options) {
    ...
    var transform = function(file, env, cb) {
        ...
        var csvConverter = new Converter({delimiter: delimiter,constructResult: false});
        ...
        csvConverter.fromString(file.contents);
    };
